...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ce-15.3.svg)](https://hub.docker.com/r/alvistack/gitlab-ce-15.3)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/gitlab-ce-15.3`](https://hub.docker.com/r/alvistack/gitlab-ce-15.3)
      - [`packer/docker-15.3/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-15.3/packer.json)
  - [`alvistack/gitlab-ce-15.2`](https://hub.docker.com/r/alvistack/gitlab-ce-15.2)
      - [`packer/docker-15.2/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-15.2/packer.json)
...
Start GitLab CE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ce-15.3
