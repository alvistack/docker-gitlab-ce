...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ce-13.8.svg)](https://hub.docker.com/r/alvistack/gitlab-ce-13.8)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/gitlab-ce-13.8`](https://hub.docker.com/r/alvistack/gitlab-ce-13.8)
      - [`packer/docker-13.8/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-13.8/packer.json)
  - [`alvistack/gitlab-ce-13.7`](https://hub.docker.com/r/alvistack/gitlab-ce-13.7)
      - [`packer/docker-13.7/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-13.7/packer.json)
...
Start GitLab CE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ce-13.8
