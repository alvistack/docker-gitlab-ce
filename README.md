...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ce-13.10.svg)](https://hub.docker.com/r/alvistack/gitlab-ce-13.10)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/gitlab-ce-13.10`](https://hub.docker.com/r/alvistack/gitlab-ce-13.10)
      - [`packer/docker-13.10/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-13.10/packer.json)
  - [`alvistack/gitlab-ce-13.9`](https://hub.docker.com/r/alvistack/gitlab-ce-13.9)
      - [`packer/docker-13.9/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-13.9/packer.json)
...
Start GitLab CE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ce-13.10
