...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ce-16.5.svg)](https://hub.docker.com/r/alvistack/gitlab-ce-16.5)
...
-   [`alvistack/gitlab-ce-16.5`](https://hub.docker.com/r/alvistack/gitlab-ce-16.5)
    -   [`packer/docker-16.5/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-16.5/packer.json)
-   [`alvistack/gitlab-ce-16.4`](https://hub.docker.com/r/alvistack/gitlab-ce-16.4)
    -   [`packer/docker-16.4/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-16.4/packer.json)
...
Start GitLab CE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ce-16.5
