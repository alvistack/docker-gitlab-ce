...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ce-14.1.svg)](https://hub.docker.com/r/alvistack/gitlab-ce-14.1)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/gitlab-ce-14.1`](https://hub.docker.com/r/alvistack/gitlab-ce-14.1)
      - [`packer/docker-14.1/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-14.1/packer.json)
  - [`alvistack/gitlab-ce-14.0`](https://hub.docker.com/r/alvistack/gitlab-ce-14.0)
      - [`packer/docker-14.0/packer.json`](https://github.com/alvistack/docker-gitlab-ce/blob/master/packer/docker-14.0/packer.json)
...
Start GitLab CE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ce-14.1
